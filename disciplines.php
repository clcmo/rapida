            ...
            <div class="box content">
                ...
                <section class="info-tiles">
                    <form action="" method="post">
                                    ...
                                    <div class="column">
                                        <div class="field" id="name_dis">
                                            ...
                                            <div class="control has-icons-left has-icons-right">
                                                <input class="input is-link" type="text" placeholder="<?php echo $name_dis; ?>" value="<?php echo $name_dis; ?>" <?php echo $disabled; ?>>
                                        ...
                                        <div class="field" id="classroom">
                                            ...
                                            <div class="control has-icons-left">
                                                <div class="select is-hovered is-link">
                                                    <select name="classroom" <?php echo $disabled; ?>>
                                ...
                                <div class="columns">
                                    <div class="column">
                                        <div class="field" id="class_day">
                                            ...
                                            <div class="control has-icons-left">
                                                <div class="select is-hovered is-link">
                                                    <select value="class_day" <?php echo $disabled; ?>>
                                    ...
                                    <div class="column">
                                        <div class="field" id="time_start">
                                            ...
                                            <div class="control has-icons-left">
                                                <div class="select is-hovered is-link">
                                                    <select value="time_start" <?php echo $disabled; ?>>
                        ...
                        <div class="columns">
                            <div class="column">
                                <input class="button is-block is-success is-large is-fullwidth" type="submit" name="save" value="Salvar" <?php echo $disabled; ?>/>
                            </div>
                            <div class="column">
                ...
                <p class="subtitle is-6 has-text-centered">
                    <?php
                        if(isset($_POST['save']) || isset($_POST['edit'])){
                            ...
                            $con = $PDO->query($Tables->SelectFrom(null, 'disciplines, courses WHERE disciplines.id_cou = courses.id_cou AND disciplines.id_dis = '.$id)) or die ($PDO);
                        ...
                        if(isset($_POST['save'])) {
                            $stmt = $PDO->prepare("INSERT INTO disciplines (name_dis, id_cou, id_tea, classroom, time_start, time_end, status_dis) VALUES (:name_dis , :id_cou, :id_tea, :classroom, :time_start :time_end, 1)");
