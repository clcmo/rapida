                    ...
                    <table class="table is-fullwidth is-striped">
					    ...
					    while($row = $query->fetch(PDO::FETCH_OBJ)){
					    	...
					    	switch ($row->$status_table) {
								case 1:
									$action_link = 'deactivate?t='.$name_page.'?id='.$row->$id;
									$action_color = 'danger';
									$action_button = '<i class="fas fa-minus-circle"></i>';
								break;

								case 2: 
									$action_link = 'activate?t='.$name_page.'?id='.$row->$id;
					    	...
					    	switch ($name_page) {
					    		...
					    		case 'disciplines':
					    			...
					    			$col_3 = '<a class="button is-'.$col_period.' is-small">'.$period.'</a>';
